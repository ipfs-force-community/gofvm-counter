...
type IStateClient interface {
	...
	Increase(context.Context, *typegen.CborInt) error

	Get(context.Context) (typegen.CborInt, error)
}
...
func (c *StateClient) Increase(ctx context.Context, p0 *typegen.CborInt) error {
...
func (c *StateClient) Get(ctx context.Context) (typegen.CborInt, error) {
	if c.actor == address.Undef {
